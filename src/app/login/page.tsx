...
export default function Login() {
    ...
    <input type="email" id="email" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="monica@gmai.com" required />
...
<button className=" w-full bg-[#3c7225] hover:bg-[#5AAC38] text-white font-bold py-2 px-4 rounded-full">Login</button>
        ...
        <div className="flex flex-col justify-center items-center mt-12 space-y-5">
          <hr className="border-t border-green-800 border-1 w-full mx-auto" />
           ...
           <Link className="block text-sm font-medium text-[#5AAC38] dark:text-white" href={'/register'}> Ainda não tem Cadastro? Cadastrar</Link>
